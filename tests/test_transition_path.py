...
class TestTransitionPath(unittest.TestCase):
    def test_no_throw(self):
        ...
        msg = ""
        try:
            ceBulk, calc = get_small_BC_with_ce_calc()
            chem_pot = {"c1_0":-1.065}
            ...
            mc = SGCNucleation(calc.atoms, T, nucleation_sampler=sampler, \
            ...
            try:
                ...
                folder="data", path_length=4, max_attempts=1, nsteps=int(0.1*len(calc.atoms)) )
